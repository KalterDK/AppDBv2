...
ROOT_URLCONF = 'AppDBv2.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR + '/AppDBv2/templates/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'AppDBv2.wsgi.application'
...
STATICFILES_DIRS = (os.path.join(BASE_DIR+'/AppDBv2/', 'static'), )
